...
class WorkSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Work::query()->forceCreate([
            ...
            'order' => 4,
            'en' => [
                'title' => 'Software Developer @ Klipbox',
        ...
        Work::query()->forceCreate([
            ...
            'order' => 6,
            'en' => [
                'title' => 'Software Developer @ Mobister',
        ...
        Work::query()->forceCreate([
            ...
            'order' => 7,
            'en' => [
                'title' => 'Lead Software Developer @ Mobister',
            ...
            'pt_BR' => [
                'title' => 'Lider de Desenvolvedor @ Mobister',
        ...
        Work::query()->forceCreate([
            ...
            'order' => 9,
            'en' => [
                'title' => 'Software Developer @ SignUp Content',
            ...
            'pt_BR' => [
                'title' => 'Desenvolvedor @ SignUp Content',
        ...
        Work::query()->forceCreate([
            ...
            'order' => 10,
            'en' => [
                'title' => 'IT Manager @ Rits Tecnologia',
            ...
            'pt_BR' => [
                'title' => 'Desenvolvedor @ Rits Tecnologia',

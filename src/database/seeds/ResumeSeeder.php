    ...
    public function run()
    {
        Resume::query()->forceCreate([
            ...
            'en' => [
                ...
                'specialties' => '<p class="font-weight-bold">- Software Architecture<br>- System Operations<br>- Amazon Web Services<br>- Laravel Framework<br>- Rails Framework<br>- VueJS Framework</p>',
                'skills' => '<p>WordPress, ES6, Project Management, Leadership, Search Engine Optimization.</p>',
            ...
            'pt-BR' => [
                ...
                'specialties' => '<p class="font-weight-bold">- Arquitetura de Software<br>- System Operations<br>- Amazon Web Services<br>- Laravel Framework<br>- Rails Framework<br>- VueJS Framework</p>',
                'skills' => '<p>WordPress, ES6, Project Management, Leadership, Search Engine Optimization.</p>',

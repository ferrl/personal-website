    ...
    public function run()
    {
        Resume::query()->forceCreate([
            ...
            'pt_BR' => [
                ...
                'contact' => '<p>Consulte-me sobre disponibilidade e orçamentos. Você pode me encontrar no <a href="mailto:me@ferrl.io">e-mail</a> ou <a href="skype:lucasferreira_113">skype</a>. Normalmente devo levar no máximo 1 dia para responder.</p>',

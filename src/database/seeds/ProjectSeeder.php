    ...
    public function run()
    {
        ...
        Project::query()->forceCreate([
            ...
            'en' => [
                ...
                'content' => '<p>Using the SignUp Content <abbr title="Minimum Viable Product">MVP</abbr>, I\'ve developed an subscription e-commerce for a group of very influential brazilian speakers: <a href="http://www.allancosta.com" hreflang="pt-BR" target="_blank" rel="nofollow noopener">Allan Costa</a>, <a href="http://arthurigreja.com" hreflang="pt-BR" target="_blank" rel="nofollow noopener">Arthur Igreja</a> and <a href="http://ricamconsultoria.com.br" hreflang="pt-BR" target="_blank" rel="nofollow noopener">Ricardo Amorim</a>, the most influential economist in Brazil (Forbes) and #1 LinkedIn Influencer.</p><p>To access the <a href="http://aaa.academy" hreflang="pt-BR" target="_blank" rel="nofollow noopener">AAA</a> content, you must subscribe to one of the personal or corporate plans. For free you can watch the <a href="http://aaa.academy/webinar" hreflang="pt-BR" target="_blank" rel="nofollow noopener">launching webinar</a> replay.</p>',
            ],
            'pt_BR' => [
                'title' => 'Inversa - Plataforma de Assinatura',
                'content' => '<p>Utilizando o <abbr title="Minimum Viable Product">MVP</abbr> do SignUp Content, desenvolvi uma plataforma de assinaturas para um grupo de palestrantes: <a href="http://www.allancosta.com" hreflang="pt-BR" target="_blank" rel="nofollow noopener">Allan Costa</a>, <a href="http://arthurigreja.com" hreflang="pt-BR" target="_blank" rel="nofollow noopener">Arthur Igreja</a> e <a href="http://ricamconsultoria.com.br" hreflang="pt-BR" target="_blank" rel="nofollow noopener">Ricardo Amorim</a>, o economista mais influente do Brasil (Forbes) e #1 LinkedIn Influencer.</p><p>Para acessar o  conteúdo do <a href="http://aaa.academy" hreflang="pt-BR" target="_blank" rel="nofollow noopener">AAA</a>, você precisa assinar um dos planos pessoais ou corporativos. Gratuitamento você pode assistir a gravação do <a href="http://aaa.academy/webinar" hreflang="pt-BR" target="_blank" rel="nofollow noopener">webinar de lançamento</a>.</p>',
            ],
        ]);
